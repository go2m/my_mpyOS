...
def main(parameters={'_debug':False}):    
    ...
    '''
    if _debug:
        print('debug is on, level:',_debug)
        print('__name__:',__name__)
    if _debug == 11 or _debug == 13:
        print('------------------- globals ------------------->APP')
        d = dict(globals())
        '''
    ...
    if _debug == 12 or _debug == 13:
        print('------------------- locals ------------------->APP')
        d = dict(locals())
        print('number of variables:',len(d))
        for name in d:
            if name != 'd':
                print('{}{} : {}'.format(name,'.'*(27-len(name)),locals()[name]))
    #'''
    if _debug:
        print()
    ...
    if len(parameters) == 1:
        ...
        return_code=mem(parameters['para1'],_debug)
    elif len(parameters) == 3:
        return_code=mem(parameters['para1'],_debug=parameters['para2'])
